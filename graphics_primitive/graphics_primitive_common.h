...
static constexpr unsigned GRAPH_PRIM_POINT_COLOR = 4u;            // point.                                2 float4 per primitive
static constexpr unsigned GRAPH_PRIM_LINE_COLOR = 5u;             // line.                                 3 float4 per primitive
static constexpr unsigned GRAPH_PRIM_LINE_SEGMENT_COLOR = 6u;     // line segment.                         3 float4 per primitive
static constexpr unsigned GRAPH_PRIM_LINE_SEGMENT_DIR_COLOR = 7u; // directed line segment==vector==arrow. 3 float4 per primitive

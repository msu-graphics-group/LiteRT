...
void litert_test_31_fake_nurbs_render()
{
  ...
  RBezierGrid vase = nurbs2rbezier(test_nurbs_loader(nurbs_path / "vase.nurbss"));
  RBezierGrid square = nurbs2rbezier(test_nurbs_loader(nurbs_path/"square.nurbss"));
  RBezierGrid cylinder = nurbs2rbezier(test_nurbs_loader(nurbs_path/"cylinder.nurbss"));

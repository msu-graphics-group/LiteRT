...
#endif
{
  ...
  uint32_t AddGeom_COctreeV1(COctreeV1View octree, ISceneObject *fake_this, BuildOptions a_qualityLevel = BUILD_HIGH);
  uint32_t AddGeom_COctreeV2(COctreeV2View octree, ISceneObject *fake_this, BuildOptions a_qualityLevel = BUILD_HIGH);

...
VkDescriptorSetLayout MultiRenderer_gpu_rq::CreatePackXYMegaDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_gpu_rq::CreateCastRayFloatSingleMegaDSLayout()
{
  std::array<VkDescriptorSetLayoutBinding, 55+1> dsBindings;
  ...
  dsBindings[25].descriptorType     = VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR;
  ...
  dsBindings[48].descriptorType     = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
  ...
  dsBindings[48].descriptorCount    = m_vdata.m_texturesArrayMaxSize;
...
VkDescriptorSetLayout MultiRenderer_gpu_rq::CreateCastRaySingleMegaDSLayout()
{
  std::array<VkDescriptorSetLayoutBinding, 55+1> dsBindings;
...
VkDescriptorSetLayout MultiRenderer_gpu_rq::CreatecopyKernelFloatDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_gpu_rq::CreatematMulTransposeDSLayout()
{
...
void MultiRenderer_gpu_rq::InitAllGeneratedDescriptorSets_PackXY()
{
  ...
  // descriptor set #0: PackXYMegaCmd (["m_packedXY"])
  {
    ...
    std::array<VkAccelerationStructureKHR,  1 + additionalSize> accelStructs;
    std::array<VkWriteDescriptorSetAccelerationStructureKHR,  1 + additionalSize> descriptorAccelInfo;
...
void MultiRenderer_gpu_rq::InitAllGeneratedDescriptorSets_CastRayFloatSingle()
{
  // now create actual bindings
  //
  // descriptor set #1: CastRayFloatSingleMegaCmd (["out_color","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_instanceData","m_pAccelStruct_m_SdfSBSAdaptData","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_NURBS_approxes","m_pAccelStruct_m_geomData","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfFrameOctreeTexNodes","m_pAccelStruct_m_SdfCompactOctreeRotModifiers","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfFrameOctreeTexRoots","m_pAccelStruct_m_abstractObjectPtrs","m_pAccelStruct_m_SdfCompactOctreeV2Data","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfCompactOctreeV3Data","m_pAccelStruct_m_RibbonHeaders","m_pAccelStruct_m_SdfSBSDataF","m_pAccelStruct_m_origNodes","m_lights","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfGridData","m_geomOffsets","m_pAccelStruct_m_SdfSBSAdaptDataF","m_normals","m_pAccelStruct","m_pAccelStruct_startEnd","m_pAccelStruct_m_vertNorm","m_pAccelStruct_m_SdfSBSAdaptHeaders","m_pAccelStruct_m_SdfSBSAdaptRoots","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_CatmulClarkHeaders","m_pAccelStruct_m_GraphicsPrimHeaders","m_pAccelStruct_m_indices","m_materials","m_matIdbyPrimId","m_pAccelStruct_m_SdfSBSAdaptNodes","m_pAccelStruct_m_SdfSBSRoots","m_packedXY","all_references","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_primIdCount","m_pAccelStruct_m_NURBSHeaders","m_pAccelStruct_m_nodesTLAS","m_textures","m_instanceTransformInvTransposed","m_matIdOffsets","m_pAccelStruct_m_GraphicsPrimPoints","m_pAccelStruct_m_NURBSData","m_indices","m_vertices"])
  {
    constexpr uint additionalSize = 1;

    std::array<VkDescriptorBufferInfo, 55 + additionalSize> descriptorBufferInfo;
    std::array<VkDescriptorImageInfo,  55 + additionalSize> descriptorImageInfo;
    std::array<VkAccelerationStructureKHR,  55 + additionalSize> accelStructs;
    std::array<VkWriteDescriptorSetAccelerationStructureKHR,  55 + additionalSize> descriptorAccelInfo;
    std::array<VkWriteDescriptorSet,   55 + additionalSize> writeDescriptorSet;
    ...
    descriptorBufferInfo[4].buffer = m_vdata.m_pAccelStruct_m_SdfSBSDataBuffer;
    descriptorBufferInfo[4].offset = m_vdata.m_pAccelStruct_m_SdfSBSDataOffset;
    ...
    descriptorBufferInfo[5].buffer = m_vdata.m_pAccelStruct_m_NURBS_approxesBuffer;
    descriptorBufferInfo[5].offset = m_vdata.m_pAccelStruct_m_NURBS_approxesOffset;
    ...
    descriptorBufferInfo[6].buffer = m_vdata.m_pAccelStruct_m_geomDataBuffer;
    descriptorBufferInfo[6].offset = m_vdata.m_pAccelStruct_m_geomDataOffset;
    ...
    descriptorBufferInfo[7].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsBuffer;
    descriptorBufferInfo[7].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsOffset;
    ...
    descriptorBufferInfo[8].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexNodesBuffer;
    descriptorBufferInfo[8].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexNodesOffset;
    ...
    descriptorBufferInfo[10].buffer = m_vdata.m_pAccelStruct_m_SdfSVSNodesBuffer;
    descriptorBufferInfo[10].offset = m_vdata.m_pAccelStruct_m_SdfSVSNodesOffset;
    ...
    descriptorBufferInfo[11].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexRootsBuffer;
    descriptorBufferInfo[11].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexRootsOffset;
    ...
    descriptorBufferInfo[13].buffer = m_vdata.m_pAccelStruct_m_SdfCompactOctreeV2DataBuffer;
    descriptorBufferInfo[13].offset = m_vdata.m_pAccelStruct_m_SdfCompactOctreeV2DataOffset;
    ...
    descriptorBufferInfo[14].buffer = m_vdata.m_pAccelStruct_m_SdfSVSRootsBuffer;
    descriptorBufferInfo[14].offset = m_vdata.m_pAccelStruct_m_SdfSVSRootsOffset;
    ...
    descriptorBufferInfo[16].buffer = m_vdata.m_pAccelStruct_m_RibbonHeadersBuffer;
    descriptorBufferInfo[16].offset = m_vdata.m_pAccelStruct_m_RibbonHeadersOffset;
    ...
    descriptorBufferInfo[17].buffer = m_vdata.m_pAccelStruct_m_SdfSBSDataFBuffer;
    descriptorBufferInfo[17].offset = m_vdata.m_pAccelStruct_m_SdfSBSDataFOffset;
    ...
    descriptorBufferInfo[20].buffer = m_vdata.m_pAccelStruct_m_SdfSBSNodesBuffer;
    descriptorBufferInfo[20].offset = m_vdata.m_pAccelStruct_m_SdfSBSNodesOffset;
    ...
    descriptorBufferInfo[21].buffer = m_vdata.m_pAccelStruct_m_SdfGridDataBuffer;
    descriptorBufferInfo[21].offset = m_vdata.m_pAccelStruct_m_SdfGridDataOffset;
    ...
    descriptorBufferInfo[22].buffer = m_vdata.m_geomOffsetsBuffer;
    descriptorBufferInfo[22].offset = m_vdata.m_geomOffsetsOffset;
    ...
    descriptorBufferInfo[23].buffer = m_vdata.m_pAccelStruct_m_SdfSBSAdaptDataFBuffer;
    descriptorBufferInfo[23].offset = m_vdata.m_pAccelStruct_m_SdfSBSAdaptDataFOffset;
    ...
    descriptorBufferInfo[24].buffer = m_vdata.m_normalsBuffer;
    descriptorBufferInfo[24].offset = m_vdata.m_normalsOffset;
    ...
    {
      VulkanRTX* pScene = dynamic_cast<VulkanRTX*>(m_pAccelStruct->UnderlyingImpl(1));
      if(pScene == nullptr)
        std::cout << "[MultiRenderer_gpu_rq::InitAllGeneratedDescriptorSets_CastRayFloatSingle]: fatal error, wrong accel struct type" << std::endl;
      accelStructs       [25] = pScene->GetSceneAccelStruct();
      descriptorAccelInfo[25] = {VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR,VK_NULL_HANDLE,1,&accelStructs[25]};
    }
    ...
    writeDescriptorSet[25].descriptorType = VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR;
    writeDescriptorSet[25].pNext          = &descriptorAccelInfo[25];

    descriptorBufferInfo[26]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[26].buffer = m_vdata.m_pAccelStruct_startEndBuffer;
    descriptorBufferInfo[26].offset = m_vdata.m_pAccelStruct_startEndOffset;
    ...
    descriptorBufferInfo[27].buffer = m_vdata.m_pAccelStruct_m_vertNormBuffer;
    descriptorBufferInfo[27].offset = m_vdata.m_pAccelStruct_m_vertNormOffset;
    ...
    descriptorBufferInfo[28].buffer = m_vdata.m_pAccelStruct_m_SdfSBSAdaptHeadersBuffer;
    descriptorBufferInfo[28].offset = m_vdata.m_pAccelStruct_m_SdfSBSAdaptHeadersOffset;
    ...
    descriptorBufferInfo[29].buffer = m_vdata.m_pAccelStruct_m_SdfSBSAdaptRootsBuffer;
    descriptorBufferInfo[29].offset = m_vdata.m_pAccelStruct_m_SdfSBSAdaptRootsOffset;
    ...
    descriptorBufferInfo[30].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeNodesBuffer;
    descriptorBufferInfo[30].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeNodesOffset;
    ...
    descriptorBufferInfo[31].buffer = m_vdata.m_pAccelStruct_m_vertPosBuffer;
    descriptorBufferInfo[31].offset = m_vdata.m_pAccelStruct_m_vertPosOffset;
    ...
    descriptorBufferInfo[32].buffer = m_vdata.m_pAccelStruct_m_SdfSBSHeadersBuffer;
    descriptorBufferInfo[32].offset = m_vdata.m_pAccelStruct_m_SdfSBSHeadersOffset;
    ...
    descriptorBufferInfo[33].buffer = m_vdata.m_pAccelStruct_m_CatmulClarkHeadersBuffer;
    descriptorBufferInfo[33].offset = m_vdata.m_pAccelStruct_m_CatmulClarkHeadersOffset;
    ...
    descriptorBufferInfo[34].buffer = m_vdata.m_pAccelStruct_m_GraphicsPrimHeadersBuffer;
    descriptorBufferInfo[34].offset = m_vdata.m_pAccelStruct_m_GraphicsPrimHeadersOffset;
    ...
    descriptorBufferInfo[35].buffer = m_vdata.m_pAccelStruct_m_indicesBuffer;
    descriptorBufferInfo[35].offset = m_vdata.m_pAccelStruct_m_indicesOffset;
    ...
    descriptorBufferInfo[36].buffer = m_vdata.m_materialsBuffer;
    descriptorBufferInfo[36].offset = m_vdata.m_materialsOffset;
    ...
    descriptorBufferInfo[37].buffer = m_vdata.m_matIdbyPrimIdBuffer;
    descriptorBufferInfo[37].offset = m_vdata.m_matIdbyPrimIdOffset;
    ...
    descriptorBufferInfo[38].buffer = m_vdata.m_pAccelStruct_m_SdfSBSAdaptNodesBuffer;
    descriptorBufferInfo[38].offset = m_vdata.m_pAccelStruct_m_SdfSBSAdaptNodesOffset;
    ...
    descriptorBufferInfo[39].buffer = m_vdata.m_pAccelStruct_m_SdfSBSRootsBuffer;
    descriptorBufferInfo[39].offset = m_vdata.m_pAccelStruct_m_SdfSBSRootsOffset;
    ...
    descriptorBufferInfo[40].buffer = m_vdata.m_packedXYBuffer;
    descriptorBufferInfo[40].offset = m_vdata.m_packedXYOffset;
    ...
    descriptorBufferInfo[41].buffer = m_vdata.all_referencesBuffer;
    descriptorBufferInfo[41].offset = m_vdata.all_referencesOffset;
    ...
    descriptorBufferInfo[42].buffer = m_vdata.m_pAccelStruct_m_SdfGridOffsetsBuffer;
    descriptorBufferInfo[42].offset = m_vdata.m_pAccelStruct_m_SdfGridOffsetsOffset;
    ...
    descriptorBufferInfo[43].buffer = m_vdata.m_pAccelStruct_m_SdfGridSizesBuffer;
    descriptorBufferInfo[43].offset = m_vdata.m_pAccelStruct_m_SdfGridSizesOffset;
    ...
    descriptorBufferInfo[44].buffer = m_vdata.m_pAccelStruct_m_allNodePairsBuffer;
    descriptorBufferInfo[44].offset = m_vdata.m_pAccelStruct_m_allNodePairsOffset;
    ...
    descriptorBufferInfo[45].buffer = m_vdata.m_pAccelStruct_m_primIdCountBuffer;
    descriptorBufferInfo[45].offset = m_vdata.m_pAccelStruct_m_primIdCountOffset;
    ...
    descriptorBufferInfo[46].buffer = m_vdata.m_pAccelStruct_m_NURBSHeadersBuffer;
    descriptorBufferInfo[46].offset = m_vdata.m_pAccelStruct_m_NURBSHeadersOffset;
    ...
    descriptorBufferInfo[47].buffer = m_vdata.m_pAccelStruct_m_nodesTLASBuffer;
    descriptorBufferInfo[47].offset = m_vdata.m_pAccelStruct_m_nodesTLASOffset;
    ...
    writeDescriptorSet[48].descriptorCount  = m_texturesInfo.size();
    writeDescriptorSet[48].descriptorType   = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    writeDescriptorSet[48].pBufferInfo      = nullptr;
    writeDescriptorSet[48].pImageInfo       = m_texturesInfo.data();
    writeDescriptorSet[48].pTexelBufferView = nullptr;

    descriptorBufferInfo[49]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[49].buffer = m_vdata.m_instanceTransformInvTransposedBuffer;
    descriptorBufferInfo[49].offset = m_vdata.m_instanceTransformInvTransposedOffset;
    ...
    descriptorBufferInfo[50].buffer = m_vdata.m_matIdOffsetsBuffer;
    descriptorBufferInfo[50].offset = m_vdata.m_matIdOffsetsOffset;
    ...
    descriptorBufferInfo[51].buffer = m_vdata.m_pAccelStruct_m_GraphicsPrimPointsBuffer;
    descriptorBufferInfo[51].offset = m_vdata.m_pAccelStruct_m_GraphicsPrimPointsOffset;
    ...
    descriptorBufferInfo[52].buffer = m_vdata.m_pAccelStruct_m_NURBSDataBuffer;
    descriptorBufferInfo[52].offset = m_vdata.m_pAccelStruct_m_NURBSDataOffset;
    ...
    descriptorBufferInfo[53].buffer = m_vdata.m_indicesBuffer;
    descriptorBufferInfo[53].offset = m_vdata.m_indicesOffset;
    ...
    writeDescriptorSet[53].dstSet           = m_allGeneratedDS[1];
    ...
    descriptorBufferInfo[54].buffer = m_vdata.m_verticesBuffer;
    descriptorBufferInfo[54].offset = m_vdata.m_verticesOffset;
    ...
    writeDescriptorSet[54].dstSet           = m_allGeneratedDS[1];
    ...
    descriptorBufferInfo[55].buffer = m_classDataBuffer;
    descriptorBufferInfo[55].offset = 0;
    ...
    writeDescriptorSet[55].dstSet           = m_allGeneratedDS[1];
...
void MultiRenderer_gpu_rq::InitAllGeneratedDescriptorSets_CastRaySingle()
{
  // now create actual bindings
  //
  // descriptor set #2: CastRaySingleMegaCmd (["out_color","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_instanceData","m_pAccelStruct_m_SdfSBSAdaptData","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_NURBS_approxes","m_pAccelStruct_m_geomData","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfFrameOctreeTexNodes","m_pAccelStruct_m_SdfCompactOctreeRotModifiers","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfFrameOctreeTexRoots","m_pAccelStruct_m_abstractObjectPtrs","m_pAccelStruct_m_SdfCompactOctreeV2Data","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfCompactOctreeV3Data","m_pAccelStruct_m_RibbonHeaders","m_pAccelStruct_m_SdfSBSDataF","m_pAccelStruct_m_origNodes","m_lights","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfGridData","m_geomOffsets","m_pAccelStruct_m_SdfSBSAdaptDataF","m_normals","m_pAccelStruct","m_pAccelStruct_startEnd","m_pAccelStruct_m_vertNorm","m_pAccelStruct_m_SdfSBSAdaptHeaders","m_pAccelStruct_m_SdfSBSAdaptRoots","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_CatmulClarkHeaders","m_pAccelStruct_m_GraphicsPrimHeaders","m_pAccelStruct_m_indices","m_materials","m_matIdbyPrimId","m_pAccelStruct_m_SdfSBSAdaptNodes","m_pAccelStruct_m_SdfSBSRoots","m_packedXY","all_references","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_primIdCount","m_pAccelStruct_m_NURBSHeaders","m_pAccelStruct_m_nodesTLAS","m_textures","m_instanceTransformInvTransposed","m_matIdOffsets","m_pAccelStruct_m_GraphicsPrimPoints","m_pAccelStruct_m_NURBSData","m_indices","m_vertices"])
  {
    constexpr uint additionalSize = 1;
...

    {
      VulkanRTX* pScene = dynamic_cast<VulkanRTX*>(m_pAccelStruct->UnderlyingImpl(1));
      if(pScene == nullptr)
        std::cout << "[MultiRenderer_gpu_rq::InitAllGeneratedDescriptorSets_CastRaySingle]: fatal error, wrong accel struct type" << std::endl;
      accelStructs       [25] = pScene->GetSceneAccelStruct();
      descriptorAccelInfo[25] = {VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR,VK_NULL_HANDLE,1,&accelStructs[25]};
    }
    writeDescriptorSet[25]                  = VkWriteDescriptorSet{};
    ...
    writeDescriptorSet[53]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[53].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    writeDescriptorSet[53].dstSet           = m_allGeneratedDS[2];
    writeDescriptorSet[53].dstBinding       = 53;
    writeDescriptorSet[53].descriptorCount  = 1;
    writeDescriptorSet[53].descriptorType   = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    writeDescriptorSet[53].pBufferInfo      = &descriptorBufferInfo[53];
    ...
    writeDescriptorSet[54]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[54].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    writeDescriptorSet[54].dstSet           = m_allGeneratedDS[2];
    writeDescriptorSet[54].dstBinding       = 54;
    writeDescriptorSet[54].descriptorCount  = 1;
    writeDescriptorSet[54].descriptorType   = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    writeDescriptorSet[54].pBufferInfo      = &descriptorBufferInfo[54];
    ...
    writeDescriptorSet[55]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[55].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    writeDescriptorSet[55].dstSet           = m_allGeneratedDS[2];
    writeDescriptorSet[55].dstBinding       = 55;
    writeDescriptorSet[55].descriptorCount  = 1;
    writeDescriptorSet[55].descriptorType   = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    writeDescriptorSet[55].pBufferInfo      = &descriptorBufferInfo[55];

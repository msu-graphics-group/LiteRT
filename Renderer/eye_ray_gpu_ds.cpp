...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_PackXY()
{
  ...
  //
  // descriptor set #0: PackXYMegaCmd (["m_packedXY","m_pAccelStruct_m_indices","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_RFGridData","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_RFGridScales","m_pAccelStruct_m_RFGridSizes","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_SdfSBSRemap","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_SdfSVSNodes"])
  {
    ...
    descriptorBufferInfo[3].buffer = m_vdata.m_pAccelStruct_m_SdfSBSDataBuffer;
    descriptorBufferInfo[3].offset = m_vdata.m_pAccelStruct_m_SdfSBSDataOffset;
    ...
    descriptorBufferInfo[4].buffer = m_vdata.m_pAccelStruct_m_SdfSBSNodesBuffer;
    descriptorBufferInfo[4].offset = m_vdata.m_pAccelStruct_m_SdfSBSNodesOffset;
    ...
    descriptorBufferInfo[21].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeNodesBuffer;
    descriptorBufferInfo[21].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeNodesOffset;
    ...
    descriptorBufferInfo[25].buffer = m_vdata.m_pAccelStruct_m_geomOffsetsBuffer;
    descriptorBufferInfo[25].offset = m_vdata.m_pAccelStruct_m_geomOffsetsOffset;
    ...
    descriptorBufferInfo[26].buffer = m_vdata.m_pAccelStruct_m_geomIdByInstIdBuffer;
    descriptorBufferInfo[26].offset = m_vdata.m_pAccelStruct_m_geomIdByInstIdOffset;
    ...
    descriptorBufferInfo[31].buffer = m_vdata.m_pAccelStruct_m_ConjIndicesBuffer;
    descriptorBufferInfo[31].offset = m_vdata.m_pAccelStruct_m_ConjIndicesOffset;
...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_CastRaySingle()
{
  // now create actual bindings
  //
  // descriptor set #1: CastRaySingleMegaCmd (["out_color","m_pAccelStruct_m_indices","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_RFGridData","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfOctreeRoots","m_packedXY","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_RFGridScales","m_pAccelStruct_m_RFGridSizes","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_SdfSBSRemap","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_SdfSVSNodes"])
  {
    constexpr uint additionalSize = 1;
    ...
    descriptorBufferInfo[19]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[19].buffer = m_vdata.m_pAccelStruct_m_nodesTLASBuffer;
    descriptorBufferInfo[19].offset = m_vdata.m_pAccelStruct_m_nodesTLASOffset;
    descriptorBufferInfo[19].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[19]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[19].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;

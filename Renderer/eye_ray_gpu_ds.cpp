...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_PackXY()
{
  ...
  //
  // descriptor set #0: PackXYMegaCmd (["m_packedXY","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_indices"])
  {
    ...
    descriptorBufferInfo[10].buffer = m_vdata.m_pAccelStruct_m_SdfGridDataBuffer;
    descriptorBufferInfo[10].offset = m_vdata.m_pAccelStruct_m_SdfGridDataOffset;
    ...
    descriptorBufferInfo[15].buffer = m_vdata.m_pAccelStruct_m_SdfObjectsBuffer;
    descriptorBufferInfo[15].offset = m_vdata.m_pAccelStruct_m_SdfObjectsOffset;
    ...
    descriptorBufferInfo[16].buffer = m_vdata.m_pAccelStruct_m_SdfGridSizesBuffer;
    descriptorBufferInfo[16].offset = m_vdata.m_pAccelStruct_m_SdfGridSizesOffset;
    ...
    descriptorBufferInfo[17].buffer = m_vdata.m_pAccelStruct_m_SdfConjunctionsBuffer;
    descriptorBufferInfo[17].offset = m_vdata.m_pAccelStruct_m_SdfConjunctionsOffset;
...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_CastRaySingle()
{
  // now create actual bindings
  //
  // descriptor set #1: CastRaySingleMegaCmd (["out_color","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_indices","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_ConjIndices","m_packedXY","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_geomTypeByGeomId"])
  {
    constexpr uint additionalSize = 1;
    ...
    descriptorBufferInfo[17]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[17].buffer = m_vdata.m_pAccelStruct_m_SdfObjectsBuffer;
    descriptorBufferInfo[17].offset = m_vdata.m_pAccelStruct_m_SdfObjectsOffset;
    descriptorBufferInfo[17].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[17]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[17].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[18]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[18].buffer = m_vdata.m_pAccelStruct_m_SdfGridSizesBuffer;
    descriptorBufferInfo[18].offset = m_vdata.m_pAccelStruct_m_SdfGridSizesOffset;
    descriptorBufferInfo[18].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[18]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[18].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[19]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[19].buffer = m_vdata.m_pAccelStruct_m_SdfConjunctionsBuffer;
    descriptorBufferInfo[19].offset = m_vdata.m_pAccelStruct_m_SdfConjunctionsOffset;
    descriptorBufferInfo[19].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[19]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[19].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[21]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[21].buffer = m_vdata.m_pAccelStruct_m_geomTypeByGeomIdBuffer;
    descriptorBufferInfo[21].offset = m_vdata.m_pAccelStruct_m_geomTypeByGeomIdOffset;
    descriptorBufferInfo[21].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[21]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[21].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;

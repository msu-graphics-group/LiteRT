...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_PackXY()
{
  ...
  //
  // descriptor set #0: PackXYMegaCmd (["m_packedXY","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_indices","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_SdfOctreeNodes"])
  {
    ...
    descriptorBufferInfo[2].buffer = m_vdata.m_pAccelStruct_m_SdfConjunctionsBuffer;
    descriptorBufferInfo[2].offset = m_vdata.m_pAccelStruct_m_SdfConjunctionsOffset;
...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_CastRaySingle()
{
  // now create actual bindings
  //
  // descriptor set #1: CastRaySingleMegaCmd (["out_color","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_indices","m_packedXY","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_geomIdByInstId"])
  {
    constexpr uint additionalSize = 1;
    ...
    descriptorBufferInfo[7]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[7].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeNodesBuffer;
    descriptorBufferInfo[7].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeNodesOffset;
    descriptorBufferInfo[7].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[7]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[7].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[8]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[8].buffer = m_vdata.m_pAccelStruct_m_SdfOctreeRootsBuffer;
    descriptorBufferInfo[8].offset = m_vdata.m_pAccelStruct_m_SdfOctreeRootsOffset;
    descriptorBufferInfo[8].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[8]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[8].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[9]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[9].buffer = m_vdata.m_pAccelStruct_m_geomTypeByGeomIdBuffer;
    descriptorBufferInfo[9].offset = m_vdata.m_pAccelStruct_m_geomTypeByGeomIdOffset;
    descriptorBufferInfo[9].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[9]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[9].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[18]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[18].buffer = m_vdata.m_pAccelStruct_m_instMatricesInvBuffer;
    descriptorBufferInfo[18].offset = m_vdata.m_pAccelStruct_m_instMatricesInvOffset;
    descriptorBufferInfo[18].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[18]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[18].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[22]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[22].buffer = m_vdata.m_pAccelStruct_m_SdfOctreeNodesBuffer;
    descriptorBufferInfo[22].offset = m_vdata.m_pAccelStruct_m_SdfOctreeNodesOffset;
    descriptorBufferInfo[22].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[22]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[22].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[24]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[24].buffer = m_vdata.m_pAccelStruct_m_geomIdByInstIdBuffer;
    descriptorBufferInfo[24].offset = m_vdata.m_pAccelStruct_m_geomIdByInstIdOffset;
    descriptorBufferInfo[24].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[24]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[24].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;

...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_PackXY()
{
  ...
  // descriptor set #0: PackXYMegaCmd (["m_packedXY","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_RFGridData","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_RFGridScales","m_pAccelStruct_m_RFGridSizes","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_indices","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_SdfSBSRemap","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfSBSNodes"])
  {
    ...
    descriptorBufferInfo[1].buffer = m_vdata.m_pAccelStruct_m_nodesTLASBuffer;
    descriptorBufferInfo[1].offset = m_vdata.m_pAccelStruct_m_nodesTLASOffset;
    ...
    descriptorBufferInfo[25].buffer = m_vdata.m_pAccelStruct_m_SdfObjectsBuffer;
    descriptorBufferInfo[25].offset = m_vdata.m_pAccelStruct_m_SdfObjectsOffset;
    ...
    descriptorBufferInfo[26].buffer = m_vdata.m_pAccelStruct_m_indicesBuffer;
    descriptorBufferInfo[26].offset = m_vdata.m_pAccelStruct_m_indicesOffset;
    ...
    descriptorBufferInfo[30].buffer = m_vdata.m_pAccelStruct_m_SdfSBSRemapBuffer;
    descriptorBufferInfo[30].offset = m_vdata.m_pAccelStruct_m_SdfSBSRemapOffset;
    ...
    descriptorBufferInfo[31].buffer = m_vdata.m_pAccelStruct_m_SdfGridDataBuffer;
    descriptorBufferInfo[31].offset = m_vdata.m_pAccelStruct_m_SdfGridDataOffset;
    ...
    descriptorBufferInfo[32].buffer = m_vdata.m_pAccelStruct_m_SdfSBSNodesBuffer;
    descriptorBufferInfo[32].offset = m_vdata.m_pAccelStruct_m_SdfSBSNodesOffset;
...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_CastRaySingle()
{
  // now create actual bindings
  //
  // descriptor set #1: CastRaySingleMegaCmd (["out_color","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_RFGridData","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfOctreeRoots","m_packedXY","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_RFGridScales","m_pAccelStruct_m_RFGridSizes","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_indices","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_SdfSBSRemap"])
  {
    constexpr uint additionalSize = 1;
    ...
    descriptorBufferInfo[2]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[2].buffer = m_vdata.m_pAccelStruct_m_SdfSVSNodesBuffer;
    descriptorBufferInfo[2].offset = m_vdata.m_pAccelStruct_m_SdfSVSNodesOffset;
    descriptorBufferInfo[2].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[2]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[2].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[3]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[3].buffer = m_vdata.m_pAccelStruct_m_SdfSBSNodesBuffer;
    descriptorBufferInfo[3].offset = m_vdata.m_pAccelStruct_m_SdfSBSNodesOffset;
    descriptorBufferInfo[3].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[3]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[3].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[28]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[28].buffer = m_vdata.m_pAccelStruct_m_SdfObjectsBuffer;
    descriptorBufferInfo[28].offset = m_vdata.m_pAccelStruct_m_SdfObjectsOffset;
    descriptorBufferInfo[28].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[28]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[28].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[29]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[29].buffer = m_vdata.m_pAccelStruct_m_indicesBuffer;
    descriptorBufferInfo[29].offset = m_vdata.m_pAccelStruct_m_indicesOffset;
    descriptorBufferInfo[29].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[29]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[29].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[30]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[30].buffer = m_vdata.m_pAccelStruct_m_geomTypeByGeomIdBuffer;
    descriptorBufferInfo[30].offset = m_vdata.m_pAccelStruct_m_geomTypeByGeomIdOffset;
    descriptorBufferInfo[30].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[30]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[30].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[31]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[31].buffer = m_vdata.m_pAccelStruct_m_origNodesBuffer;
    descriptorBufferInfo[31].offset = m_vdata.m_pAccelStruct_m_origNodesOffset;
    descriptorBufferInfo[31].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[31]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[31].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;

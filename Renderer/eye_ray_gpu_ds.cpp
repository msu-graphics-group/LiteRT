...
void EyeRayCaster_GPU::InitAllGeneratedDescriptorSets_CastRaySingle()
{
  // now create actual bindings
  //
  // descriptor set #1: CastRaySingleMegaCmd (["out_color","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_indices","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_vertPos","m_packedXY","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_SdfConjunctions"])
  {
    constexpr uint additionalSize = 1;

...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_PackXY()
{
  ...
  // descriptor set #0: PackXYMegaCmd (["m_packedXY","m_pAccelStruct_m_indices","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_RFGridData","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_RFGridScales","m_pAccelStruct_m_RFGridSizes","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfSBSRemap","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_ConjIndices"])
  {
    ...
    descriptorBufferInfo[9].buffer = m_vdata.m_pAccelStruct_m_RFGridSizesBuffer;
    descriptorBufferInfo[9].offset = m_vdata.m_pAccelStruct_m_RFGridSizesOffset;
    ...
    descriptorBufferInfo[10].buffer = m_vdata.m_pAccelStruct_m_SdfConjunctionsBuffer;
    descriptorBufferInfo[10].offset = m_vdata.m_pAccelStruct_m_SdfConjunctionsOffset;
...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_CastRaySingle()
{
  ...
  // descriptor set #1: CastRaySingleMegaCmd (["out_color","m_pAccelStruct_m_indices","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_RFGridData","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfOctreeRoots","m_packedXY","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_RFGridScales","m_pAccelStruct_m_RFGridSizes","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfSBSRemap","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfSBSNodes"])
  {
    ...
    descriptorBufferInfo[11]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[11].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsBuffer;
    descriptorBufferInfo[11].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsOffset;
    descriptorBufferInfo[11].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[11]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[11].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[12]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[12].buffer = m_vdata.m_pAccelStruct_m_SdfConjunctionsBuffer;
    descriptorBufferInfo[12].offset = m_vdata.m_pAccelStruct_m_SdfConjunctionsOffset;
    descriptorBufferInfo[12].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[12]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[12].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;

...
void MultiRenderer_GPU::AllocateAllDescriptorSets()
{
  ...
  buffersSize.descriptorCount          = 47 + 64; // + 64 for reserve
...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_PackXY()
{
  ...
  //
  // descriptor set #0: PackXYMegaCmd (["m_packedXY","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_indices","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters"])
  {
    ...
    descriptorBufferInfo[15].buffer = m_vdata.m_pAccelStruct_m_geomIdByInstIdBuffer;
    descriptorBufferInfo[15].offset = m_vdata.m_pAccelStruct_m_geomIdByInstIdOffset;
    ...
    descriptorBufferInfo[16].buffer = m_vdata.m_pAccelStruct_m_geomOffsetsBuffer;
    descriptorBufferInfo[16].offset = m_vdata.m_pAccelStruct_m_geomOffsetsOffset;
...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_CastRaySingle()
{
  // now create actual bindings
  //
  // descriptor set #1: CastRaySingleMegaCmd (["out_color","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_indices","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_ConjIndices","m_packedXY","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfOctreeNodes"])
  {
    constexpr uint additionalSize = 1;
    ...
    descriptorBufferInfo[19]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[19].buffer = m_vdata.m_pAccelStruct_m_SdfParametersBuffer;
    descriptorBufferInfo[19].offset = m_vdata.m_pAccelStruct_m_SdfParametersOffset;
    descriptorBufferInfo[19].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[19]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[19].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[20]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[20].buffer = m_vdata.m_pAccelStruct_m_instMatricesInvBuffer;
    descriptorBufferInfo[20].offset = m_vdata.m_pAccelStruct_m_instMatricesInvOffset;
    descriptorBufferInfo[20].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[20]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[20].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;

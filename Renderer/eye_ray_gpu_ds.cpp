...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_PackXY()
{
  ...
  //
  // descriptor set #0: PackXYMegaCmd (["m_packedXY","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_RFGridScales","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_RFGridSizes","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_RFGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfOctreeRoots","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfSBSRemap","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_indices"])
  {
    ...
    descriptorBufferInfo[5].buffer = m_vdata.m_pAccelStruct_m_geomOffsetsBuffer;
    descriptorBufferInfo[5].offset = m_vdata.m_pAccelStruct_m_geomOffsetsOffset;
    ...
    descriptorBufferInfo[8].buffer = m_vdata.m_pAccelStruct_m_SdfSBSDataBuffer;
    descriptorBufferInfo[8].offset = m_vdata.m_pAccelStruct_m_SdfSBSDataOffset;
    ...
    descriptorBufferInfo[9].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsBuffer;
    descriptorBufferInfo[9].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsOffset;
    ...
    descriptorBufferInfo[11].buffer = m_vdata.m_pAccelStruct_m_RFGridScalesBuffer;
    descriptorBufferInfo[11].offset = m_vdata.m_pAccelStruct_m_RFGridScalesOffset;
    ...
    descriptorBufferInfo[13].buffer = m_vdata.m_pAccelStruct_m_vertPosBuffer;
    descriptorBufferInfo[13].offset = m_vdata.m_pAccelStruct_m_vertPosOffset;
    ...
    descriptorBufferInfo[14].buffer = m_vdata.m_pAccelStruct_m_RFGridSizesBuffer;
    descriptorBufferInfo[14].offset = m_vdata.m_pAccelStruct_m_RFGridSizesOffset;
    ...
    descriptorBufferInfo[18].buffer = m_vdata.m_pAccelStruct_m_RFGridDataBuffer;
    descriptorBufferInfo[18].offset = m_vdata.m_pAccelStruct_m_RFGridDataOffset;
    ...
    descriptorBufferInfo[19].buffer = m_vdata.m_pAccelStruct_m_SdfGridOffsetsBuffer;
    descriptorBufferInfo[19].offset = m_vdata.m_pAccelStruct_m_SdfGridOffsetsOffset;
    ...
    descriptorBufferInfo[20].buffer = m_vdata.m_pAccelStruct_m_SdfGridSizesBuffer;
    descriptorBufferInfo[20].offset = m_vdata.m_pAccelStruct_m_SdfGridSizesOffset;
    ...
    descriptorBufferInfo[24].buffer = m_vdata.m_pAccelStruct_m_SdfNeuralPropertiesBuffer;
    descriptorBufferInfo[24].offset = m_vdata.m_pAccelStruct_m_SdfNeuralPropertiesOffset;
...
void MultiRenderer_GPU::InitAllGeneratedDescriptorSets_CastRaySingle()
{
  // now create actual bindings
  //
  // descriptor set #1: CastRaySingleMegaCmd (["out_color","m_pAccelStruct_m_ConjIndices","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_indices","m_pAccelStruct_m_SdfObjects","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_RFGridData","m_pAccelStruct_m_geomOffsets","m_pAccelStruct_m_SdfOctreeNodes","m_pAccelStruct_m_geomIdByInstId","m_pAccelStruct_m_SdfConjunctions","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_instMatricesInv","m_pAccelStruct_m_SdfParameters","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_SdfNeuralProperties","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_SdfOctreeRoots","m_packedXY","m_pAccelStruct_m_bvhOffsets","m_pAccelStruct_m_RFGridScales","m_pAccelStruct_m_RFGridSizes","m_pAccelStruct_m_vertPos","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_geomTypeByGeomId","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_SdfSBSRemap","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfSBSNodes"])
  {
    constexpr uint additionalSize = 1;
    ...
    descriptorBufferInfo[3]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[3].buffer = m_vdata.m_pAccelStruct_m_indicesBuffer;
    descriptorBufferInfo[3].offset = m_vdata.m_pAccelStruct_m_indicesOffset;
    descriptorBufferInfo[3].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[3]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[3].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[4]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[4].buffer = m_vdata.m_pAccelStruct_m_SdfObjectsBuffer;
    descriptorBufferInfo[4].offset = m_vdata.m_pAccelStruct_m_SdfObjectsOffset;
    descriptorBufferInfo[4].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[4]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[4].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
